      ...
      <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <section className="surface rounded-[32px] p-6 sm:p-8">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-heading)] text-4xl leading-tight">
            Create a business account in minutes, then finish KYB only when it matters.
          </h1>
          <RegisterForm />
        </section>
        ...
        <section className="metric-cream rounded-[32px] border border-[var(--color-line)] p-8">
          ...
          <h2 className="mt-4 font-[family-name:var(--font-heading)] text-3xl leading-tight">
            Warm like Gusto, serious like payroll.
          </h2>
          <p className="mt-4 text-sm leading-7 text-[var(--color-ink-soft)]">
            The onboarding shell is intentionally short, progress-oriented, and gentle with trust
            cues about partner banks, notifications, and first disbursement readiness.
          </p>
